...
<footer>
            ...
            <div class="footer footer_bottom">
                ...
                <div class="footer-col">
                    ...
                    <div class="footer-col-content">
                        <ul class="social">
                            <li>
                                <a href="#" class="fb"><img src="<?php echo BASE_URL ?>/public/image/Fb.png">Facebook</a>
                            </li>
                            <li>
                                <a href="#" class="fb"><img src="<?php echo BASE_URL ?>/public/image/Gg.png">Google</a>
                            </li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                        ...
                        <ul class="icon_list">
                            <li>
                                <a href=".">
                                    ...
                                    <p class="text_li">
                                        <span class="phone_footer">Hotline: 0912605156</span>
                                        <span class="text_small">(Từ 8h đến 20h tất cả các ngày)</span>
                                    </p>
                                </a>
                            </li>
                            <div class="clear"></div>
                            <li><a><i class="fa fa-envelope" aria-hidden="true"></i> trannhonhoa2001@gmail.com</a></li>
                            <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i> https://mobilephone.com</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="clear"></div>
    <div class="copyright">
        <h4 class="tkw9999">&copy; Bản quyền thuộc về DH20TH1. Designed by <a href="http://webextrasite.com/" rel="dofollow" target="_blank">Trần Nhơn Hòa</a> Bởi <a href="http://webextrasite.com/"> trannhonhoa2001@gmail.com</a></h4>
    </div>
</footer>
